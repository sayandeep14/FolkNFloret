...
export default defineConfig([
  ...
  // Generated by `prisma generate`, gitignored, and not ours to style.
  {
    // `const { a: _a, ...rest } = obj` is the idiom for omitting a key. The
    // binding is unused by design; the underscore says so.
    rules: {
  ...
  globalIgnores([".next/**", "out/**", "next-env.d.ts", "lib/generated/**"]),
]);
